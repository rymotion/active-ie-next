        ...
        <Screen>
          <div className="flex flex-row min-h-screen min-w-screen justify-center items-center h-full w-full">
            ...
            <blockquote
              ...
              data-instgrm-permalink="https://www.instagram.com/actv_ie/?utm_source=ig_embed&amp;utm_campaign=loading"
              data-instgrm-version="14"
            >
              <div>
                <a
                  href="https://www.instagram.com/actv_ie/?utm_source=ig_embed&amp;utm_campaign=loading"
                  className="
        background: #ffffff;
        line-height: 0;
        padding: 0 0;
